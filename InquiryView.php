...
<body>
  ...
  <div style="text-align: center;">
    ...
    <a class="nav-btn" href="inquiryAdd.php">Add New Inquiry</a>
  </div>

  <div class="container">
    <h1 class="title">Students of Records</h1>
    ...
    <div class="table-wrapper">
      <table>
        ...
        <?php
		  ...
		  $query = mysqli_query($con, "SELECT * FROM inquiry ORDER BY i_id DESC");
        ...
        ?>
          <tr>
            ...
            <td class="action-icons">
              <a href="inquiryUpdate.php?id=<?php echo $temp[0]; ?>">
                <img src="./image/edit.png" alt="Edit">
              </a>
            </td>
            <td class="action-icons">
              <a href="inquiryDelete.php?id=<?php echo $temp[0]; ?>" onclick="return confirm('Are you sure you want to delete this entry?');">
